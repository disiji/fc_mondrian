...
def print_partitions(partition, trans_level=1., color='k'):
    ...
    if not partition[1] and not partition[2]: 
        plt.plot([partition[0][0,0], partition[0][0,0]], [partition[0][1,0], partition[0][1,1]], color+'-', linewidth=3, alpha=trans_level)
        plt.plot([partition[0][0,1], partition[0][0,1]], [partition[0][1,0], partition[0][1,1]], color+'-', linewidth=3, alpha=trans_level)
        plt.plot([partition[0][0,0], partition[0][0,1]], [partition[0][1,0], partition[0][1,0]], color+'-', linewidth=3, alpha=trans_level)
        plt.plot([partition[0][0,0], partition[0][0,1]], [partition[0][1,1], partition[0][1,1]], color+'-', linewidth=3, alpha=trans_level)
